...
def gui_build():
    delta_arr, graph_arr, legend_name_array = Compute.calculate_delta_to_rate_plot()
    fig = Visual.vis_inst.fig_elaborate(delta_arr, graph_arr, legend_name_array)
...
def gui_run(window):
    ...
    while True:
        ...
        if event == "Add":
            ...
            if not is_already_shown((bound_type_req, q_req)):
                list_of_shown_bounds.append(Compute.create_bound(bound_formal_name_to_func_name[bound_type_req], q_req))
